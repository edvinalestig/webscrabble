...
class App < Sinatra::Base
    ...
    get("/p1") do
        return "<h1>You are now player 1</h1><p><a href='/getp1'>Get data</a></p><script>#{File.read('webapp/post.js')}</script>"
    end


    get("/p2") do
        return "<h1>You are now player 2</h1><p><a href='/getp2'>Get data</a></p><script>#{File.read('webapp/post.js')}</script>"
    end
